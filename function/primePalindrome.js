// check the input number is palindrome as well as prime
...
function checkPrime(inputNum) {
  ...
  if (isPrime) console.log(inputNum + " is a Prime Number");
...
function checkPalindrome(inputNum) {
  ...
  } else console.log(inputNum + " is not a palindrome number.");
}

let inputNum = readline.question("Enter the number :");
if (parseInt(inputNum) === 1) console.log("1 is not prime number");
else {
