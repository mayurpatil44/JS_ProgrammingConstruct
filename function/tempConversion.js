...
let choiceInput = readline.question(
  "Convert temperature into 1.Fahrenheit 2.Celsius: "
);
...
switch (choice) {
  case CELSIUS_TO_FAHRENHEIT:
    ...
    else console.log("Temperature should be within 0-100 C.");
    break;
  case FAHRENHEIT_TO_CELCSIOUS:
    if (temperature >= 32 && temperature <= 212) getDegreeCelsius(temperature);
    else console.log("Temperature should be within 32-212 F.");
    break;
  default:
